...
func _physics_process(delta: float) -> void:
	...
	vertical = Input.get_axis("Down2", "Up2")
	horizontal = Input.get_axis("Left2", "Right2")
...
func fill_list() -> void:
	...
	if Input.is_action_pressed("LP2"):
		newButtons[0] = 1
	if Input.is_action_pressed("MP2"):
		newButtons[1] = 1
	if Input.is_action_pressed("HP2"):
		newButtons[2] = 1
	if Input.is_action_pressed("LK2"):
		newButtons[3] = 1
	if Input.is_action_pressed("MK2"):
		newButtons[4] = 1
	if Input.is_action_pressed("HK2"):
		newButtons[5] = 1
